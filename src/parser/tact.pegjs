/*
 * Tact Language Grammar, based on Javascript grammar.
...
InitOfToken     = "initOf"     !IdentifierPart
...
FunctionToken   = "fun"        !IdentifierPart
NativeToken     = "native"     !IdentifierPart
...
MappingToken    = "map"        !IdentifierPart
...
BuilderToken       = "Builder"          !IdentifierPart
SliceToken         = "Slice"            !IdentifierPart
CellToken          = "Cell"             !IdentifierPart
AddressToken       = "Address"          !IdentifierPart
StringToken        = "String"           !IdentifierPart
StringBuilderToken = "StringBuilder"    !IdentifierPart
StateInitToken     = "StateInit"        !IdentifierPart

PrimitiveToken     = "primitive"        !IdentifierPart
...
MemberExpression
  = head:(
      ...
      / InitOfToken __ callee:Type __ args:Arguments {
          return {
...
InitOfExpression
  = MemberExpression
  / InitOfToken __ callee:InitOfExpression {
      return { type: "InitOfExpression", callee: callee, arguments: [], start: location().start.offset, end: location().end.offset };
    }
...
Type
  ...
  / FunctionToken __ funcName:FunctionName parts:(__"[" __ (Expression)? __ "]")*
    {
      return {
        type: "Type",
        literal: "function",
...
PrimitiveStatement
  = PrimitiveToken __ id:Identifier EOS
  {
    return {
      type: "PrimitiveStatement",
      name: id.name,
      start: location().start.offset,
      end: location().end.offset
    }
...
MessageDeclaration
  = MessageToken code:("(" __ NumericLiteral __ ")")? __ id:Identifier __ "{" __ body:SourceElements? __ "}"
  {
    return {
      type: "MessageDeclaration",
      name: id.name,
      code: code != null ? code[2] : "",
      body: optionalList(body),
      start: location().start.offset,
      end: location().end.offset
    }
...
InitDeclaration
  = InitToken __ params:("(" __ InformalParameterList? __ ")") __ body:FunctionBody
    {
      return {
...
ReceiveDeclaration
  = ReceiveToken __ params:("(" __ InformalParameterList? __ ")") __ body:FunctionBody
    {
      return {
...
ReturnsDeclarations
  = ":" __ returnParams:ReturnsDeclaration? isoptional:"?"?
  {
...
InformalParameter
  = id:Identifier? __ ":" __ type:Type isoptional:"?"?
  {
    return {
...
StructDeclaration
  = StructToken __ id:Identifier __ "{" __ body:SourceElements? __ "}"
  {
    return {
